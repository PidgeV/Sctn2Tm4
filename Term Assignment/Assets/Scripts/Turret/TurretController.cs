...
public class TurretController : AdvancedFSM
{
    ...
    [SerializeField] Transform shotSpawnPosition;
    public Light light;
    ...
    public void Shoot()
    {
        ...
        GameObject shot = GameObject.Instantiate(bullet, shotSpawnPosition);
        ...
        {
            rigidbody.velocity = playerTransform.position + (offset * 2 - shot.transform.position);
        }
    }
